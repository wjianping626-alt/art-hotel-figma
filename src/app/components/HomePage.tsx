  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      ...
      <motion.div
        ...
        style={{ paddingTop: "clamp(40px, 12vh, 80px)" }}
      >
        <p style={{ fontFamily: "var(--font-inter)", fontSize: "11px", letterSpacing: "0.3em", color: "#A8673A", fontWeight: 500 }} className="mb-4">
        ...
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "13px", fontWeight: 300, color: "rgba(244,240,234,0.75)", letterSpacing: "0.25em", marginTop: "12px" }}>
          麻黄梁艺术家酒店
        </p>
      </motion.div>
      ...
      >
        <div className="px-5">
          <div className="rounded-3xl p-5 backdrop-blur-lg" style={{ background: "rgba(10,6,3,0.35)", border: "1px solid rgba(244,240,234,0.12)" }}>
            <p style={{ fontFamily: "var(--font-sans)", fontSize: "10px", color: "rgba(244,240,234,0.5)", letterSpacing: "0.3em", fontWeight: 300 }} className="mb-4 text-center">
              抵达 · Arrival · 请选择您的身份
            </p>
            <div className="flex gap-3">
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="flex-1 rounded-2xl py-4 px-4 text-left transition-all duration-300"
                style={{
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <div style={{ fontFamily: "var(--font-sans)", fontSize: "13px", fontWeight: 600, color: "#F4F0EA" }}>艺术旅客</div>
                </div>
                <div style={{ fontFamily: "var(--font-sans)", fontSize: "10px", color: "rgba(244,240,234,0.6)", lineHeight: 1.5 }}>
                  艺术家 · 独行旅客 · 观光团队
                </div>
                <div style={{ fontFamily: "var(--font-inter)", fontSize: "9px", color: "#A8673A", marginTop: "8px", letterSpacing: "0.15em" }}>
                  住宿流线 →
                </div>
              </motion.button>
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <div style={{ fontFamily: "var(--font-sans)", fontSize: "13px", fontWeight: 600, color: "#F4F0EA" }}>外来旅客</div>
                </div>
                <div style={{ fontFamily: "var(--font-sans)", fontSize: "10px", color: "rgba(244,240,234,0.6)", lineHeight: 1.5 }}>
                  观景探索 · 一日游访客
                </div>
